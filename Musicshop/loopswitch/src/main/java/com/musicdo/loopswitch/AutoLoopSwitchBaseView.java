...
public abstract class AutoLoopSwitchBaseView extends RelativeLayout implements ViewPager.OnPageChangeListener {
  ...
  public boolean onTouchEvent(MotionEvent event) {
    switch (event.getAction()){
      case MotionEvent.ACTION_UP:
        Log.i("AutoLoopSwitchBaseView","onTouchEvent$$$$ACTION_UP");
        break;
      case MotionEvent.ACTION_DOWN:
        Log.i("AutoLoopSwitchBaseView","onTouchEvent$$$$ACTION_DOWN");
        break;
    }
  ...
  public boolean onInterceptTouchEvent(MotionEvent ev) {
    switch(ev.getAction()){
      case MotionEvent.ACTION_DOWN:
        Log.i("AutoLoopSwitchBaseView", "onInterceptTouchEvent-ACTION_DOWN...");
        break;
      case MotionEvent.ACTION_UP:
        Log.i("AutoLoopSwitchBaseView", "onInterceptTouchEvent-ACTION_UP...");
        break;
      default:break;
    }
    return false;//1.true进行拦截 2.false Touch事件向下一级的View的dispatchTouchEvent()分发
//    return super.onInterceptTouchEvent(ev);//将会对该Touch事件进行拦截，会响应当前View的  OnTouchEvent()
  }
  ...
  public boolean dispatchTouchEvent(MotionEvent ev) {
    switch (ev.getAction()){
      case MotionEvent.ACTION_UP:
        Log.i("AutoLoopSwitchBaseView","dispatchTouchEvent$$$$ACTION_UP");
        break;
      case MotionEvent.ACTION_DOWN:
        Log.i("AutoLoopSwitchBaseView","dispatchTouchEvent$$$$ACTION_DOWN");
        break;
    }
